...
#include <string>
#include <sstream>
#include "open_manipulator_gui/qnode.hpp"

/*****************************************************************************
** Namespaces
*****************************************************************************/

namespace open_manipulator_gui {
...
bool QNode::init() {
  ros::init(init_argc_,init_argv_,"open_manipulator_gui");
  ...
  joint_pose_msg_pub_ = n.advertise<sensor_msgs::JointState>("/robotis/base/joint_pose_msg", 0);
  kinematics_pose_msg_pub_ = n.advertise<geometry_msgs::Pose>("/robotis/base/kinematics_pose_msg", 0);

  write_msg_pub = n.advertise<std_msgs::String>("/robotis/base/write_msg", 100);

//  get_joint_pose_client_ = n.serviceClient<sensor_msgs::JointState>("/robotis/base/get_joint_pose", 0);
//  get_kinematics_pose_client_ = n.serviceClient<geometry_msgs::Pose>("/robotis/base/get_kinematics_pose", 0);
...
void QNode::sendJointPoseMsg( sensor_msgs::JointState msg )
{
...
void QNode::sendKinematicsPoseMsg( geometry_msgs::Pose msg )
{
...
void QNode::sendWriteMsg( std_msgs::String msg)
{
 //   ROS_INFO("1");
  write_msg_pub.publish( msg );

  log( Info , "Send write Msg" );
}
